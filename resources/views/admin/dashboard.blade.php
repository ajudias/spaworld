...
<head>
    ...
    <!-- DataTables -->
    <link href="/admin-theme/assets/libs/datatables.net-bs4/css/dataTables.bootstrap4.min.css" rel="stylesheet" type="text/css" />
    <link href="/admin-theme/assets/libs/datatables.net-buttons-bs4/css/buttons.bootstrap4.min.css" rel="stylesheet" type="text/css" />

    <!-- Responsive datatable examples -->
    <link href="/admin-theme/assets/libs/datatables.net-responsive-bs4/css/responsive.bootstrap4.min.css" rel="stylesheet" type="text/css" />     

	<!-- Sweet Alert-->
    <link href="/admin-theme/assets/libs/sweetalert2/sweetalert2.min.css" rel="stylesheet" type="text/css" />
        
    <!-- Toast -->
    <link href="/admin-theme/assets/libs/jquery-toast-plugin\dist\jquery.toast.min.css" rel="stylesheet" type="text/css" />     
                    ...
                    <div class="d-flex">
                        ...
                        <div class="dropdown d-inline-block">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <!-- item-->
                                <a class="dropdown-item" href="{{ route('admin.changepassword') }}"><i class="bx bx-key font-size-16 align-middle mr-1"></i> Change Password</a>
...
<!-- 
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="text-sm-right d-none d-sm-block">
                                    Design & Developed by <a href="http://www.reontel.com" target="_blank">Reon Technologies</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <!-- JAVASCRIPT -->
        <script src="/admin-theme/assets/libs/jquery/jquery.min.js"></script>
        <script src="/admin-theme/assets/libs/bootstrap/js/bootstrap.bundle.min.js"></script>
        <script src="/admin-theme/assets/libs/metismenu/metisMenu.min.js"></script>
        <script src="/admin-theme/assets/libs/simplebar/simplebar.min.js"></script>
        <script src="/admin-theme/assets/libs/node-waves/waves.min.js"></script>

        <!-- Required datatable js -->
        <script src="/admin-theme/assets/libs/datatables.net/js/jquery.dataTables.min.js"></script>
        <script src="/admin-theme/assets/libs/datatables.net-bs4/js/dataTables.bootstrap4.min.js"></script>

        <!-- apexcharts -->
        <script src="/admin-theme/assets/libs/apexcharts/apexcharts.min.js"></script>
        <script src="/admin-theme/assets/js/pages/dashboard.init.js"></script>

        <!-- Datatable init js -->
        <script src="/admin-theme/assets/js/pages/datatables.init.js"></script>   

        <!-- Sweet Alerts js -->
        <script src="/admin-theme/assets/libs/sweetalert2/sweetalert2.min.js"></script>

        <!-- Sweet alert init js-->
        <script src="/admin-theme/assets/js/pages/sweet-alerts.init.js"></script>

        <!-- Toast Alert-->
        <script src="/admin-theme/assets/libs/jquery-toast-plugin/dist/jquery.toast.min.js"></script>

        <!--tinymce js-->
        <script src="/admin-theme/assets/libs/tinymce/tinymce.min.js"></script>
